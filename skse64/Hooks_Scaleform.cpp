...
RelocAddr<_UIOpenJournalMenu> UIOpenJournalMenu(0x00936D90);
...
//	void						** _vtbl;		// 00
	...
	DEFINE_MEMBER_FN(ctor_data, StandardItemData *, 0x00894150, GFxMovieView ** movieView, InventoryEntryData * objDesc, UInt64 unk);
	...
	{
		static RelocAddr<uintptr_t> kCtorHookAddress(0x00895120 + 0x97);
...
//	void			** _vtbl;	// 00
	...
	DEFINE_MEMBER_FN(ctor_data, MagicItemData *, 0x008E0BD0, GFxMovieView ** movieView, TESForm * pForm, int unk); // unk is ignored by ctor

	static uintptr_t GetCtorHookAddress()
	{
		static RelocAddr<uintptr_t> kCtorHookAddress(0x008E21F0 + 0x97);
		return kCtorHookAddress.GetUIntPtr();
	}
...
namespace favMenuDataHook
{
	...
	RelocAddr<uintptr_t> kSetItemData_Base(0x008B94F0);
	...
	RelocAddr<uintptr_t> kSetMagicData_Base(0x008BA500);
	...
	RelocAddr<uintptr_t> kSetVampireData_Base(0x008BA790);
...
{
	RelocAddr<uintptr_t> kSetData_Base(0x008AD740);
...
{
	RelocAddr<uintptr_t> kSetData_Base(0x008A4030);
...
{
	// 
	RelocAddr<uintptr_t> kSetData_Base(0x008A4560);
...
{
	// 
	RelocAddr<uintptr_t> kSetData_Base(0x008A4270);
	...
	RelocAddr<uintptr_t> kExtendCategoryArgs_Base(0x008B1BD0);
...
{
	RelocPtr<UInt64> kCtor_Base(0x005E6420 + 0xEB1);	// WinMain+15
...
RelocAddr <uintptr_t> kInstallHooks_Enter(0x00F23840 + 0x1DD);
