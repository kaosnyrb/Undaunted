...
public:
	...
	DEFINE_MEMBER_FN_1(ctor, NiNode*, 0x00C91950, UInt16 arrBufLen);
};
...
public:
	...
	DEFINE_MEMBER_FN_0(ctor, BSFadeNode *, 0x013B3C00);
};
...
public:
	...
	DEFINE_MEMBER_FN(AdjustHeadMorph, void, 0x003F3460, UInt32 unk04, UInt32 unk08, float delta);
};
