...
RelocAddr<_WorldPtToScreenPt3_Internal> WorldPtToScreenPt3_Internal(0x00CA1190);

RelocAddr<_NiAllocate> NiAllocate(0x00C5CB60);
RelocAddr<_NiFree> NiFree(0x00C5CE00);
